import cv2
import numpy as np
from linesegm2.Chunk import Chunk
from linesegm2.Line import Line
from linesegm2.Region import Region
import sys
...
class LineSegmentation:
	...
	def segment(self):
		...
		self.save_image_with_lines(self.output_path + "/Final_Lines.jpg")
